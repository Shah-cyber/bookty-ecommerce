    ...
    <div class="min-h-screen bg-[#FAF7F5]">
        ...
        <div class="relative overflow-x-hidden bg-[#FAF7F5] min-h-screen">
            ...
            <div class="absolute inset-0 overflow-hidden">
                ...
                <div class="absolute -top-40 -right-40 w-96 h-96 bg-[#9D84B7]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-60 float-animation"></div>
                <div class="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-[#E6D5E9]/40 rounded-full mix-blend-multiply filter blur-3xl opacity-60 float-animation-delayed"></div>
                <div class="absolute top-24 left-16 w-80 h-80 bg-[#FAF7F5] rounded-full mix-blend-multiply filter blur-3xl opacity-60 float-animation-slow"></div>

                <!-- Layer 2: Medium accent blobs -->
                <div class="absolute top-1/3 right-1/4 w-64 h-64 bg-[#9D84B7]/10 rounded-full mix-blend-multiply filter blur-2xl opacity-40 float-animation"></div>
                <div class="absolute bottom-1/4 right-1/3 w-72 h-72 bg-[#5D4B68]/5 rounded-full mix-blend-multiply filter blur-2xl opacity-40 float-animation-delayed"></div>
                ...
                <div class="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-32 xl:gap-40 min-h-[70vh] lg:min-h-[80vh] overflow-visible">
                    ...
                    @if($displayHeroBooks->count() > 0)
                        <div class="flex-1 lg:max-w-[42%] xl:max-w-[45%] text-gray-900 order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left flex-shrink-0" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">
                            <div class="mb-6" data-aos="fade-down" data-aos-delay="200">
                                <span class="inline-flex items-center px-5 py-2.5 bg-white/90 rounded-full text-sm font-semibold backdrop-blur-md border border-white/80 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                                    <span class="relative flex w-3 h-3 mr-2">
                                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#9D84B7] opacity-75"></span>
                                        <span class="relative inline-flex rounded-full h-3 w-3 bg-[#9D84B7]"></span>
                                    </span>
                                    <span id="hero-genre" class="text-fade text-[#5D4B68] font-medium">
                            ...
                            <h1 id="hero-title" class="text-fade text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-extrabold leading-tight mb-6 font-serif text-[#2D2D2D] drop-shadow-sm break-words" style="line-height: 1.15;" data-aos="fade-up" data-aos-delay="300">
                                {{ $firstHero?->title }}
                            </h1>
                            <p id="hero-synopsis" class="text-fade text-base md:text-lg mb-10 w-full text-[#5D4B68] leading-relaxed" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="flex flex-col sm:flex-row w-full items-stretch sm:items-center justify-center lg:justify-start gap-4 sm:gap-6" data-aos="fade-up" data-aos-delay="500">
                                <a id="hero-details-link" href="{{ $firstHero ? route('books.show', $firstHero) : '#' }}" class="group relative inline-flex items-center justify-center w-full sm:w-auto px-10 py-4 bg-[#9D84B7] text-white font-bold rounded-full transition-all duration-500 shadow-xl hover:shadow-[#9D84B7]/40 hover:scale-105 transform overflow-hidden hover:bg-[#8B72A6]">
                                ...
                                @if($firstHero)
                                    <button onclick="quickAddToCart({{ $firstHero?->id }})" id="hero-quick-add" class="quick-add-btn group relative inline-flex items-center justify-center w-full sm:w-auto px-10 py-4 border-2 border-[#9D84B7]/30 text-[#5D4B68] font-bold rounded-full bg-white/80 backdrop-blur-md hover:bg-[#FAF7F5] hover:border-[#9D84B7] transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden">
                                        <span class="absolute inset-0 bg-[#9D84B7]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                            ...
                            <!-- Enhanced Stats Row -->
                            <div class="w-full mt-16 sm:mt-20 pt-10 border-t border-[#9D84B7]/20" data-aos="fade-up" data-aos-delay="600">
                                <div class="flex items-center justify-center lg:justify-start gap-8 sm:gap-12 flex-wrap">
                                    <div class="group text-center transform hover:scale-110 transition-all duration-300" data-aos="zoom-in" data-aos-delay="200">
                                        <div class="relative inline-block mb-2">
                                            <div class="absolute inset-0 bg-[#9D84B7] rounded-2xl blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
                                            <div class="relative px-6 py-3 bg-white/80 backdrop-blur-sm rounded-2xl border border-[#9D84B7]/20">
                                                <div class="text-4xl font-extrabold text-[#2D2D2D]">10K+</div>
                                    </div>
                                    </div>
                                        <div class="text-[#5D4B68] text-sm font-semibold mt-2 flex items-center justify-center">
                                            <svg class="w-4 h-4 mr-1 text-[#9D84B7]" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="hidden sm:block w-px h-12 bg-[#9D84B7]/20"></div>
                        ...
                        <div class="flex-1 lg:max-w-[40%] xl:max-w-[35%] w-full order-1 lg:order-2 perspective-container overflow-visible flex-shrink-0 pr-4 lg:pr-6 xl:pr-8" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                            <div class="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-md xl:max-w-lg mx-auto h-[450px] sm:h-[550px] lg:h-[600px] overflow-visible">
                                ...
                                <div class="absolute inset-0 bg-[#9D84B7]/20 rounded-3xl blur-3xl scale-110 opacity-50"></div>
                        ...
                        <div class="flex-1 lg:max-w-[45%] xl:max-w-[50%] text-gray-900 order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left flex-shrink-0" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">
                            <div class="mb-6" data-aos="fade-down" data-aos-delay="200">
                                <span class="inline-flex items-center px-5 py-2.5 bg-white/90 rounded-full text-sm font-semibold backdrop-blur-md border border-white/80 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                                    ...
                                    <span class="text-[#5D4B68] font-medium">⭐ Welcome to Bookty</span>
                                </span>
                            </div>
                            ...
                            <p class="text-base md:text-lg mb-10 w-full text-[#5D4B68] leading-relaxed" data-aos="fade-up" data-aos-delay="400">
                                Your journey into the world of literature starts here. Browse our collection and find your next favorite read.
                            </p>
                            <div class="flex flex-col sm:flex-row w-full items-stretch sm:items-center justify-center lg:justify-start gap-4 sm:gap-6" data-aos="fade-up" data-aos-delay="500">
                                <a href="{{ route('books.index') }}" class="group relative inline-flex items-center justify-center w-full sm:w-auto px-10 py-4 bg-[#9D84B7] text-white font-bold rounded-full transition-all duration-500 shadow-xl hover:shadow-[#9D84B7]/40 hover:scale-105 transform overflow-hidden hover:bg-[#8B72A6]">
                                    <span class="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
                                    <span class="relative flex items-center">
                                        <svg class="w-5 h-5 mr-2 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="gallery-item group relative" data-genre-id="{{ $book->genre?->id ?? '' }}" data-aos="fade-up">
                                <a href="{{ route('books.show', $book) }}" class="block">
                                    ...
                                    <div class="absolute top-2 left-2 z-10">
                                        @if(($book->condition ?? 'new') === 'preloved')
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-amber-500/90 backdrop-blur-sm text-white shadow-md">
                                                Preloved
                                            </span>
                                        @else
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-500/90 backdrop-blur-sm text-white shadow-md">
                                                New
                                            </span>
                                        @endif
                                    </div>
        ...
        <!-- Enhanced Browse By Category (Brand Colors) -->
    <div class="py-24" style="background-color: #FAF7F5;">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16" data-aos="fade-up">
                <span class="inline-block py-1 px-3 rounded-full bg-white/50 border border-[#9D84B7]/20 text-[#5D4B68] text-sm font-medium mb-4">
                    Browse Categories
                </span>
                <h2 class="text-4xl font-bold text-[#2D2D2D] mb-4 tracking-tight font-serif">
                    Find Your Genre
                </h2>
                <p class="text-lg text-[#5D4B68]/80 max-w-2xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach($genres as $genre)
                    <a href="{{ route('books.index', ['genre' => $genre->id]) }}" class="group bg-white rounded-2xl p-8 border border-[#9D84B7]/10 hover:border-[#9D84B7] transition-all duration-300 hover:shadow-lg hover:-translate-y-1" data-aos="fade-up" data-aos-delay="{{ $loop->index * 50 }}">
                        
                        <!-- Category Icon -->
                        <div class="inline-flex items-center justify-center h-16 w-16 rounded-xl bg-[#FAF7F5] text-[#9D84B7] group-hover:bg-[#9D84B7] group-hover:text-white transition-colors duration-300 mb-6">
                            @php
                                $icons = [
                            ...
                            @endphp
                            <svg class="h-8 w-8 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Category Info -->
                        <div>
                            <h3 class="text-lg font-bold mb-1 text-[#2D2D2D] group-hover:text-[#9D84B7] transition-colors duration-300 font-serif">{{ $genre->name }}</h3>
                            <p class="text-[#5D4B68]/70 text-sm">{{ $genre->books_count }} books</p>
                        </div>
                    </a>
                @endforeach
            </div>
            ...
            <div class="text-center mt-16" data-aos="fade-up" data-aos-delay="400">
                <a href="{{ route('books.index') }}" class="inline-flex items-center px-8 py-3 border border-[#9D84B7]/30 text-base font-medium rounded-full text-[#5D4B68] bg-white hover:bg-[#FAF7F5] hover:border-[#9D84B7] transition-all duration-300">
                    View All Books
                                ...
                                <div class="relative overflow-hidden">
                                    <a href="{{ route('books.show', $book) }}" class="block">
                                        ...
                                        <div class="absolute top-4 left-4 flex flex-col gap-2">
                                            @if(($book->condition ?? 'new') === 'preloved')
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-lg">
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                                                    </svg>
                                                    Preloved
