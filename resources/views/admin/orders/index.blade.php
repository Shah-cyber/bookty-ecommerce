...
@section('content')
    <div class="mb-6">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
            <h2 class="text-2xl font-serif font-semibold text-bookty-black">Orders</h2>
                ...
                <form action="{{ route('admin.orders.index') }}" method="GET" class="flex flex-wrap gap-2">
                    ...
                    <div class="flex">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search orders..." 
                            class="rounded-l-md border-gray-300 focus:border-bookty-purple-300 focus:ring focus:ring-bookty-purple-200 focus:ring-opacity-50">
                    ...
                    <!-- Status Filter -->
                    <select name="status" onchange="this.form.submit()" class="rounded-md border-gray-300 focus:border-bookty-purple-300 focus:ring focus:ring-bookty-purple-200 focus:ring-opacity-50">
                    ...
                    <select name="payment_status" onchange="this.form.submit()" class="rounded-md border-gray-300 focus:border-bookty-purple-300 focus:ring focus:ring-bookty-purple-200 focus:ring-opacity-50">
                    ...
                    <!-- Sort Options -->
                    <select name="sort" onchange="this.form.submit()" class="rounded-md border-gray-300 focus:border-bookty-purple-300 focus:ring focus:ring-bookty-purple-200 focus:ring-opacity-50">
            ...
            <table class="w-full table-auto">
                <thead>
                    <tr class="bg-bookty-cream">
                        <th class="px-6 py-3 text-left text-xs font-medium text-bookty-black uppercase tracking-wider">Order ID</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-bookty-black uppercase tracking-wider">Customer</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-bookty-black uppercase tracking-wider">Date</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-bookty-black uppercase tracking-wider">Total</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-bookty-black uppercase tracking-wider">Status</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-bookty-black uppercase tracking-wider">Payment</th>
