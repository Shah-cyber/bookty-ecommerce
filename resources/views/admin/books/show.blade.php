            ...
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/4 mb-6 md:mb-0 md:pr-6">
                    ...
                    <div class="mt-6 flex space-x-2">
                        <a href="{{ route('admin.books.edit', $book) }}" class="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                            Edit
                        </a>
                ...
                <div class="md:w-3/4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex flex-wrap gap-2">
                                ...
                                @empty
                                    <span class="text-gray-500">No tropes assigned</span>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-lg font-semibold text-gray-900">RM {{ $book->price }}</p>
                        </div>
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Synopsis</h3>
