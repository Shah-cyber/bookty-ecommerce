...
@section('content')
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        <div class="overflow-x-auto">
            <table id="books-table" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <script>
        ...
        if (
            ...
            const table = new simpleDatatables.DataTable("#books-table", {
            ...
            // Initialize Flowbite dropdown for export functionality
