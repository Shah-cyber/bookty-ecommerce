        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <div class="mb-4">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="text" name="code" id="code" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" placeholder="e.g., SUMMER25" value="{{ old('code') }}" required>
                        </div>
                        @error('code')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="description" id="description" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" placeholder="e.g., Summer Sale Discount" value="{{ old('description') }}">
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div>
                    <div class="mb-4">
                        ...
                        <input type="number" name="min_purchase_amount" id="min_purchase_amount" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" placeholder="0.00" step="0.01" min="0" value="{{ old('min_purchase_amount', 0) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="max_uses_total" id="max_uses_total" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" placeholder="e.g., 100" min="1" value="{{ old('max_uses_total') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="max_uses_per_user" id="max_uses_per_user" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" placeholder="e.g., 1" min="1" value="{{ old('max_uses_per_user') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="expires_at" id="expires_at" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" value="{{ old('expires_at', now()->addMonths(1)->format('Y-m-d\TH:i')) }}" required>
                    @error('expires_at')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
