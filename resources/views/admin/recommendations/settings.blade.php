                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100 flex items-center">
                            <i class="fas fa-project-diagram text-blue-500 mr-2"></i> Algorithm Configuration
                        </h2>
                        <span
                            class="text-xs font-semibold bg-blue-50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-300 px-3 py-1 rounded-full border border-blue-100 dark:border-blue-800">Live
                            Preview</span>
                    </div>
                    ...
                    <form id="settingsForm" action="{{ route('admin.recommendations.settings.update') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">
                                Adjust the balance between content-based and collaborative filtering for optimal
                                recommendations.
                            </p>
                                ...
                                <div class="p-4 border-l-4 border-blue-500 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                                    ...
                                    <div class="flex items-center">
                                        <input type="number" name="content_based_weight" id="content_based_weight"
                                            ...
                                            min="0" max="1" step="0.1" value="{{ $settings['content_based_weight'] }}"
                                            onchange="updateCollaborativeWeight()">
                                        <span class="ml-2 text-sm text-gray-500">%</span>
                                    </div>
                                    <small class="text-gray-500 dark:text-gray-400">Based on book features & user
                                        preferences</small>
                                </div>
                                ...
                                <div class="p-4 border-l-4 border-green-500 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                                    ...
                                    <div class="flex items-center">
                                        <input type="number" name="collaborative_weight" id="collaborative_weight"
                                            ...
                                            min="0" max="1" step="0.1" value="{{ $settings['collaborative_weight'] }}"
                                            readonly>
                                        <span class="ml-2 text-sm text-gray-500">%</span>
                                    </div>
                            ...
                            <div class="mt-5">
                                <div class="flex justify-between items-center mb-1">
                                    <span class="font-semibold text-gray-700 dark:text-gray-200">Algorithm
                                        Distribution</span>
                                ...
                                <div class="w-full bg-gray-200 dark:bg-gray-700 h-5 rounded-full overflow-hidden">
                                    <div id="contentBasedBar"
                                        class="bg-blue-500 h-5 float-left transition-all duration-500 text-xs text-white flex items-center justify-center">
                                        Content {{ $settings['content_based_weight'] * 100 }}%
                                    </div>
                                    <div id="collaborativeBar"
                                        class="bg-green-500 h-5 float-left transition-all duration-500 text-xs text-white flex items-center justify-center">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                ...
                                <div class="p-4 border-l-4 border-cyan-500 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                                    ...
                                    <input type="number" id="min_recommendation_score" name="min_recommendation_score"
                                        value="{{ $settings['min_recommendation_score'] }}" min="0" max="1" step="0.1"
                                    ...
                                    <small class="text-gray-500 dark:text-gray-400">Books below this score won't be
                                        shown.</small>
                                </div>

                                <!-- Max Recommendations -->
                                <div
                                    class="p-4 border-l-4 border-yellow-500 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                                    <label class="block font-medium text-gray-700 dark:text-gray-200 mb-2">
                                        Max Recommendations per User
                                    </label>
                                    <input type="number" id="max_recommendations_per_user"
                                        name="max_recommendations_per_user"
                                    ...
                                    <small class="text-gray-500 dark:text-gray-400">Maximum number of books
                                        displayed.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="p-4 border-l-4 border-green-500 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                                <label class="block font-medium text-gray-700 dark:text-gray-200 mb-2">Cache Duration
                                    (hours)</label>
                        ...
                        <div>
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                <!-- Content Toggle -->
                                <div
                                    class="p-4 border-l-4 border-blue-500 rounded-lg bg-white dark:bg-gray-800 flex justify-between items-center">
                                    <div>
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        ...
                                        <div
                                            class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 
                                ...
                                <div
                                    class="p-4 border-l-4 border-green-500 rounded-lg bg-white dark:bg-gray-800 flex justify-between items-center">
                                    <div>
                                        <p class="font-medium text-gray-700 dark:text-gray-200 mb-1 flex items-center">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        ...
                                        <div
                                            class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 rounded-full peer dark:bg-gray-700 
                                                    peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] 
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 flex items-center">
                            <i class="fas fa-chart-pie text-purple-500 mr-2"></i> Current Settings
                        </h3>
                        <span
                            class="text-xs font-semibold bg-green-50 dark:bg-green-900/40 text-green-600 dark:text-green-300 px-3 py-1 rounded-full border border-green-100 dark:border-green-800">Active</span>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-center">
                            <div class="bg-blue-100 dark:bg-blue-900/40 rounded-lg p-3">
                                <div class="text-2xl font-bold text-blue-600 dark:text-blue-300">
                                    {{ $settings['content_based_weight'] * 100 }}%</div>
                            ...
                            <div class="bg-green-100 dark:bg-green-900/40 rounded-lg p-3">
                                <div class="text-2xl font-bold text-green-600 dark:text-green-300">
                                    {{ $settings['collaborative_weight'] * 100 }}%</div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
                                <div class="font-bold text-cyan-600 dark:text-cyan-300">
                                    {{ $settings['min_recommendation_score'] }}</div>
                                <small class="text-gray-500 dark:text-gray-400">Min Score</small>
                            </div>
                            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
                                <div class="font-bold text-yellow-600 dark:text-yellow-300">
                                    {{ $settings['max_recommendations_per_user'] }}</div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
                            <div class="font-bold text-green-600 dark:text-green-300">
                                {{ $settings['cache_duration_hours'] }}h</div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="flex items-center justify-center">
                                ...
                                @if($settings['enable_content_based'])
                                    <span
                                        class="bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 px-2 py-1 rounded-full text-xs font-semibold">ON</span>
                                @else
                                    <span
                                        class="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 px-2 py-1 rounded-full text-xs font-semibold">OFF</span>
                                @endif
                            </div>
                            <div class="flex items-center justify-center">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 flex items-center mb-4">
                        <i class="fas fa-rocket text-red-500 mr-2"></i> Impact Preview
                    </h3>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-3">
                        <button onclick="testRecommendations()"
                            class="w-full px-4 py-2 border border-blue-500 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900 rounded-lg transition flex items-center justify-center">
                            <i class="fas fa-play mr-2"></i> Test Recommendations
                        </button>
                        <button onclick="clearCache()"
                            class="w-full px-4 py-2 border border-cyan-500 text-cyan-600 hover:bg-cyan-50 dark:hover:bg-cyan-900 rounded-lg transition flex items-center justify-center">
                            <i class="fas fa-trash mr-2"></i> Clear Cache
                        </button>
                        <button onclick="exportSettings()"
                            class="w-full px-4 py-2 border border-green-500 text-green-600 hover:bg-green-50 dark:hover:bg-green-900 rounded-lg transition flex items-center justify-center">
