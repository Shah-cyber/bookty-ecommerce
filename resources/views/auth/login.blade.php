<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <div class="flex justify-center mt-5">
            <nav class="inline-flex rounded-md shadow-sm bg-white p-1" aria-label="Authentication tabs">
                <button type="button" class="px-8 py-2.5 text-sm font-medium bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-md transition duration-300" id="signin-tab" onclick="showTab('signin')">
                    Sign In
                </button>
                <button type="button" class="px-8 py-2.5 text-sm font-medium text-gray-700 hover:text-purple-600 transition duration-300" id="signup-tab" onclick="window.location.href='{{ route('register') }}'">
                    Sign Up
                </button>
            </nav>
        </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div class="form-group">
            ...
            <div class="relative">
                ...
                <input id="email" 
                    class="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200" 
                    type="email" 
                    name="email" 
        ...
        <div class="form-group">
            ...
            <div class="relative">
                ...
                <input id="password" 
                    class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200" 
                    type="password" 
                    name="password"
                    placeholder="••••••••" 
                    required 
        ...
        <div class="flex items-center justify-between">
            <label for="remember_me" class="flex items-center">
                <input id="remember_me" type="checkbox" class="h-4 w-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500 transition duration-150 ease-in-out" name="remember">
                <span class="ml-2 text-sm text-gray-600">Remember me</span>
            </label>
            
            @if (Route::has('password.request'))
                <a class="text-sm text-purple-600 hover:text-purple-800 font-medium transition duration-150 ease-in-out" href="{{ route('password.request') }}">
                    Forgot Password?
                </a>
            @endif
        </div>
    ...
    <div class="mt-7 text-center">
        <p class="text-sm text-gray-600">
            ...
            <a href="{{ route('register') }}" class="font-semibold text-purple-600 hover:text-purple-500 hover:underline transition duration-200">
                Register now
            </a>
        </p>
    </div>
